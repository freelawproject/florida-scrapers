...
const OSCEOLA_LOGIN_URL = "https://courts.osceolaclerk.com/BenchmarkWeb/Home.aspx/Search"
...
export const login = async (page: Page): Promise<void> => {
  await windowSet(page, "username", process.env.LOGIN_USERNAME_3)
  await windowSet(page, "password", process.env.LOGIN_PASSWORD_3)

  await waitFor(500)

  await page.goto(OSCEOLA_LOGIN_URL, { waitUntil: "domcontentloaded" })
  ...
  console.log("Not logged in. Logging in with user: ", process.env.LOGIN_USERNAME_3)
